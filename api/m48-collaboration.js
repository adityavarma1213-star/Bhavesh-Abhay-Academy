...
async function canReadPost(s,postId){
  ...
  if(isStaff(s)||p.author_user_id===s.user_id||(p.visibility==='global'&&p.moderationState==='approved'))return p;
