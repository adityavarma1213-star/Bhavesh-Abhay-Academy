...
function getAllowedOrigin() {
  // No wildcard fallback: an unset ALLOWED_ORIGIN now means "don't advertise
  // any cross-origin access" rather than "allow every origin." Same-origin
  // requests from this app's own frontend are unaffected — browsers only
  // consult Access-Control-Allow-Origin for cross-origin requests.
