...
(function (global) {
  ...
  function submitHomeworkText({ text, subjectHint, image, pdf } = {}) {
  ...
  async function evaluateSubmission(id, evalApiUrl) {
    ...
    try {
      ...
      const schemaValid = result && result.schemaVersion === 1 && result.evaluationType === 'text_only'
      ...
      const imageReviewRequired = hasImage;
