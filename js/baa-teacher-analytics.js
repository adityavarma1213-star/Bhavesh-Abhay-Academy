...
(function(global){
  ...
  function getCurrentTeacherAnalytics(){
    if(typeof global.BAAAssessment==='undefined')return {students:0,concepts:[],scope:'unavailable'};
    const store=typeof global.BAAAssessment._load==='function'?global.BAAAssessment._load():null;
    if(!store)return {students:0,concepts:[],scope:'unavailable'};
    return {
      students:1,
      concepts:summarizeSnapshot(store),
      scope:'single_student_private_testing'
    };
  }
