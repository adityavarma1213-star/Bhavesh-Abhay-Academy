...
(function(global){
  ...
  global.BAAGuideCatalogue={version:'m63.18',features:FEATURES.slice(),getFeatures:clone,getFeature:function(id){return FEATURES.find(function(f){return f.id===id;})||null;}};
