...
async function testHomeworkPath() {
  const response={schemaVersion:1,evaluationType:'image_or_text',overallAssessment:'good',summary:'Clear work.',strengths:['Good method'],mistakes:[],suggestions:['Review one step'],confidence:'high',humanReviewRequired:false,humanReviewReasons:[],imageEvaluated:false,learningSignals:[{concept:'Fractions',outcome:'good',errorType:null,confidence:'high'}]};
