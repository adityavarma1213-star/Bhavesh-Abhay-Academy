...
## Scope
Controlled cohort/experiment definitions; no claim that a one-year study has occurred.
...
## Verification
- Module-specific smoke test: `test/run-m61-tests.js`
...
## UI Reachability Completion Pass — M61
