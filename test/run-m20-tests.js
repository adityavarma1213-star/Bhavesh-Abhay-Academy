...
test('Career plan reads real academic profile evidence',()=>assert.ok(career.includes('getAcademicProfile')));
test('Career plan identifies evidence and gaps',()=>{assert.ok(career.includes('strength_evidence'));assert.ok(career.includes('support_needed'));assert.ok(career.includes('not_yet_tracked'));assert.ok(career.includes('gaps'))});
