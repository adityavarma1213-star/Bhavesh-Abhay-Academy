...
assert.match(studentWiring,/id='baa-teacher-portal-entry'/,'Student OS wiring must create a visible Teacher / Academic Management entry');
assert.match(studentWiring,/account\.html\?role=teacher/,'Teacher entry must route through the authenticated account flow');
