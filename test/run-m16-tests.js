...
const rec=fs.readFileSync('js/baa-teacher-recommendation.js','utf8');const teacher=fs.readFileSync('teacher-os.html','utf8');
...
console.log(`\nM16: ${passed}/10 PASS`);if(process.exitCode)process.exit(process.exitCode);
