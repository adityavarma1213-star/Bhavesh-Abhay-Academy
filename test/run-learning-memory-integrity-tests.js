...
// api/v1/learning-memory.js now derives status/evidence_count/correct_count from
...
// Mirrors the derivation block in api/v1/learning-memory.js exactly.
...
// the derivation is what api/v1/learning-memory.js actually writes, and it ignores any
