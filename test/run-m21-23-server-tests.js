...
const checks=[
  ...
  ['canonical question bank',api.includes('FROM questions')],
  ...
  ['practice prioritization',api.includes('prioritizedConcepts')&&api.includes('practiceQuestions')],
  ...
  ['server-backed practice render',bridge.includes('data.practiceQuestions')],
